...
pacman::p_load(tidyverse, 
               rmdformats, #output format: readthedown
               kableExtra, #pretty html tables
               gghalves, #half-half geoms
               ggdist, #density plots for distributions
               viridis, #colorblind-friendly palettes
               knitr,
               pander) # for text processing
