...
```
```{r plot specific ethnicities, message=TRUE, warning=TRUE}
...
dat %>% 
  ...
  mutate(ethnicity = factor(ethnicity, 
                           levels = c("white", "black_afram", "hispanic_latinx", "indigenous_am_indian", "asian", "pacific_islander"),
                           labels = c("White", "Black/African-American", "Hispanic/Latinx", "Indigenous/American Indian", "Asian", "Pacific Islander or Native Hawaiian"))) %>%
...
-   Are students recieving a grade bonus or a grade penalty on average in this course? (see dashed line for overall course average)
