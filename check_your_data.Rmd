...
dat <- read.csv("~/Downloads/synthetic_data_SEISMIC-format_BIO300_2023-04-08.csv")
```
...
#required variable list from Data Dictionary in Data Preparation Guide
 required_vars <- c("st_id","female","ethniccode_cat", "white", "black_afram", "hispanic_latinx", "indigenous_am_indian", 'asian', 'pacific_islander', "firstgen","lowincomeflag","transfer", "international", "crs_name", "crs_term", "crs_year", "crs_semq","crs_section", "numgrade", "gpao")
...
dat %>%
  select(female, firstgen, lowincomeflag, transfer, international,
         white, black_afram, hispanic_latinx, indigenous_am_indian, asian, pacific_islander, crs_retake)
